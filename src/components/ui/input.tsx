    ...
    return (
      <input
        ...
        className={cn(
          ...
          isFile &&
            "cursor-pointer file:cursor-pointer file:mr-3 file:rounded-md file:border file:border-input file:bg-primary file:px-4 file:py-1 file:text-sm file:font-medium file:text-primary-foreground file:shadow-sm file:hover:bg-primary/90 file:transition-colors",
